...
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
    GLUTAPI void APIENTRY glutInitDisplayString(const char *str);
#endif
...
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
    GLUTAPI int APIENTRY glutBitmapLength(void *font, const unsigned char *str);
    GLUTAPI int APIENTRY glutStrokeLength(void *font, const unsigned char *str);
#endif
...
#define GLUT_GAME_MODE_DISPLAY_CHANGED  ((GLenum) 6)
    ...
    GLUTAPI void APIENTRY glutGameModeString(const char *str);
